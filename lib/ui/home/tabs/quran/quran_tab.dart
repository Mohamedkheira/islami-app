...
class _QuranTabState extends State<QuranTab> {
  ...
  List<int> numberVerses = [7,286,200,176,120,165,206,75,129,109,123,111,43,52,99,128,111,110,98,135,112,78,118,64,77,227,93,88,
        ...
        Expanded(
          child: ListView.separated(
              itemBuilder: (context, index) {
                return QuranWidget(chapterName: chapterName[index],
                  numberVerses: numberVerses[index],
                  index: index,
                );
              },
